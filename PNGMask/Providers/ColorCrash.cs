...
namespace PNGMask.Providers
{
    ...
    {
        public ColorCrash(Stream svector, string pass, bool find = true) : base(svector, pass, find) { }
        public ColorCrash(string fvector, string pass, bool find = true) : base(fvector, pass, find) { }
        public ColorCrash(byte[] bvector, string pass, bool find = true) : base(bvector, pass, find) { }
        public ColorCrash(PNG pngvector, string pass, bool find = true) : base(pngvector, pass, find) { }

        ISAAC csprng = null;

        public override void ImprintData(byte[] data, string pass)
        {
        ...
        public override byte[] ExtractData(string pass)
        {
